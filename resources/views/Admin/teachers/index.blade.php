...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-container">
            ...
            <a href="{{ route('Admin_teachers.create') }}" class="btn-add-student">Add New Teacher</a>
        </div>

        <!-- مربع البحث عن طالب -->
        <div class="search-container">
            <form action="{{ route('Admin_teachers.index') }}" method="GET">
                <input type="text" name="search" class="search-box" placeholder="Search for a teacher...">
            </form>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- زر العرض -->
                        <a href="{{ route('Admin_teachers.show', $teacher->TeacherID) }}" class="btn btn-show">Show</a>

                        <!-- زر التحديث -->
                        <a href="{{ route('Admin_teachers.edit', $teacher->TeacherID) }}"
                            class="btn btn-primary">Update</a>

                        <!-- زر الحذف -->
                        <form action="{{ route('Admin_teachers.destroy', $teacher->TeacherID) }}" method="POST"
...
<!--         <div class="pagination-container">
        ...
        <div class="pagination-container">
            @if ($currentPage > 1)
            <form action="{{ route('Admin_teachers.index') }}" method="GET" class="pagination-btn">
                <input type="hidden" name="page" value="{{ $currentPage - 1 }}">
                <button type="submit" class="pagination-btn">Previous</button>
            </form>
            @endif
