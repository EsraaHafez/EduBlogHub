...
class BlogpostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.posts', compact('posts', 'currentUser'));
    }
       // عرض جميع المشاركات
    ...
    public function store(Request $request)
    {
        ...
        $post->AuthorID = Auth::id(); // تعيين معرف المستخدم الحالي كمالك للمنشور
        $post->save();
    ...
    {
        $post = Blogpost::where('PostID', $PostID)->where('AuthorID', Auth::id())->firstOrFail();
